...
class FournisseurController extends AbstractController
{
    ...
    #[Route('/{id_f}', name: 'app_fournisseur_show', methods: ['GET'])]
    ...
    #[Route('/{id_f}/edit', name: 'app_fournisseur_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id_f}', name: 'app_fournisseur_delete', methods: ['POST'])]
    public function delete(Request $request, Fournisseur $fournisseur, FournisseurRepository $fournisseurRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$fournisseur->getId_f(), $request->request->get('_token'))) {
