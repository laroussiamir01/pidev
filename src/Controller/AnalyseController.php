...
class AnalyseController extends AbstractController
{
    ...
    #[Route('/front', name: 'affichageA', methods: ['GET'])]
    public function affichageA(AnalyseRepository $analyseRepository): Response
    {
        return $this->render('analyse/affichageA.html.twig', [
            'analyses' => $analyseRepository->findAll(),
        ]);
    }
