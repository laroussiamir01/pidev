...
class MaterielApiController extends AbstractController
{
    #[Route('/utilisateur/api', name: 'app_utilisateur_api')]
    public function index(): Response
    {
        return $this->render('materiel_api/index.html.twig', [
            'controller_name' => 'MaterielApiController',
        ]);
    }
    ...
    #[Route('/utilisateur/display', name: 'app_display_api')]
      ...
      public function alluserAction()
      {
          ...
          $materiel = $this->getDoctrine()->getManager()->getRepository(Materiel::class)->findAll();
          $serializer = new Serializer([new ObjectNormalizer()]);
          $formatted = $serializer->normalize($materiel);
