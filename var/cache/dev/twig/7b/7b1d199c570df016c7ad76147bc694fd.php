...
class __TwigTemplate_3fec47d5f57aee093cc83af17c572aaf extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      ";
        // line 3
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 3, $this->source); })()), "roles", [], "any", false, false, false, 3), 'row');
        echo "
    <button class=\"btn\">";
        // line 4
