 ...
 */
class getEtatsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EtatsRepository' shared autowired service.
     *
     * @return \App\Repository\EtatsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EtatsRepository.php';

        return $container->privates['App\\Repository\\EtatsRepository'] = new \App\Repository\EtatsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
