 ...
 */
final class Version20230221160124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE don (id INT AUTO_INCREMENT NOT NULL, events_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_F8F081D99D6A1065 (events_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
